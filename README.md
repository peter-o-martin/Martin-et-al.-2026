...
<br>
<div align="center">
<h1>Spatial-Temporal Patterns of Perfluoroalkyl Substances in the Biota of the Laurentian Great Lakes: A Meta-Analysis
...
1. **Coding Workflow** folder: this folder contains the six R scripts that were used to process the raw data files, impute left-censored concentration values, finalize the data frame, create generalized additive models for the concentrations of six per- and polyfluoroalkyl substances (PFAS) (PFOS, PFNA, PFDA, PFUnA, PFDoA, and PFTrDA), test the models (using 80:20 holdout validation along with a supplementary validation data set), and generate figures and tables. The files within this folder are:
